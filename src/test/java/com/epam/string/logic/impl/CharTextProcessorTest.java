...
public class CharTextProcessorTest {

    private final CharTextProcessor charTextProcessor = new CharTextProcessor();
    ...
    public void processShouldReturnEqualStringWhenDataIsEmpty() {
        ...
        //when
        String actual = charTextProcessor.process(data, lengthWord, replacement);
        //then
        String expected = "";
